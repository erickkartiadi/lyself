...
import { EditStoryScreenNavigationProps } from '../../navigation/navigation.types';
...
function EditStoryScreen({
  navigation,
  route: { params },
}: EditStoryScreenNavigationProps) {
  ...
  const { data: categoryData } = useFindCategory(params.categoryId);

  const [selectedCategory, setSelectedCategory] = React.useState<string>(
    categoryData ? categoryData.nameShort : ''
  );
